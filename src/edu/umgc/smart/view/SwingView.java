...
//TODO: Create GUI for search result window.
//TODO: Link all windows together through logical paths.
//TODO: Add proper functionality to all buttons and text-fields
...
public class SwingView extends View {
  ...
  private void mainWindow(Point location){
    ...
    searchButton.addActionListener(e -> {
      System.out.println("Search Button Pressed. Searching for: " + searchBoxField.getText());
    });
  ...
  private void advancedSearchWindow(Point location){
    ...
    searchButtons[0].addActionListener(e -> {
      System.out.println("Searching by reference number: " + searchFields[0].getText());
    });

    //Title field search button
    searchButtons[1].addActionListener(e -> {
      System.out.println("Searching by title: " + searchFields[1].getText());
    });

    //Record Type field search button
    searchButtons[2].addActionListener(e -> {
      System.out.println("Searching by record type: " + searchFields[2].getText());
    });

    //Author field search button
    searchButtons[3].addActionListener(e -> {
      System.out.println("Searching by author: " + searchFields[3].getText());
    });

    //Date field search button
    searchButtons[4].addActionListener(e -> {
      System.out.println("Searching by date: " + searchFields[4].getText());
    });

    //Category field search button
    searchButtons[5].addActionListener(e -> {
      System.out.println("Searching by category: " + searchFields[5].getText());
    });

    //Summary field search button
    searchButtons[6].addActionListener(e -> {
      System.out.println("Searching by summary: " + searchFields[6].getText());
    });
  ...
  private void viewRecordWindow(Point location, ViewType viewType){
    ...
    JComboBox recordTypeComboBox = new JComboBox(RecordType.values());
    ...
    saveButton.addActionListener(e -> {
      if (viewType == ViewType.CREATE){
        System.out.println("Save - Create/Modify");
      } else if (viewType == ViewType.VIEW){
        System.out.println("Save - View");
      } else {
        //TODO: Create exception for SwingView GUI errors?
    ...
    //TODO: Display 'Modify' button for VIEW type, and 'Save' and 'Delete' for CREATE
